  ...
  return (
    <div className="relative max-w-4xl mx-auto py-6">
      ...
      <div className="mb-10">
        ...
        <p className="text-sm font-medium text-gray-500 mt-1 uppercase tracking-wider">Instructor Configuration</p>
      </div>
          ...
          <form className="space-y-6" onSubmit={handleProfileSubmit}>
            ...
            <div>
              ...
              <input
                ...
                readOnly
              />
              <p className="text-[9px] font-bold text-gray-400 mt-2 uppercase tracking-widest">Your institutional email cannot be modified.</p>
            </div>
